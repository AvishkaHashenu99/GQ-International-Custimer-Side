    ...
    return (
        <div className="itemScreen">
            ...
            <button className="btn btn-outline-danger" style={{marginLeft:'-150px',padding:'10px',height:'50px'}}>
                <a href="/items" style={{textDecoration:'none',color:'black',fontWeight:'bolder'}}>
                        Shop</a></button>
                        <br/> <br/>
                <div className="itemScreen__left">
                    <div className="left__image"> 
                        <img src={item.imageUrl} alt={item.itemCode} style={{width:'350px',height:'350px',marginLeft:'-10px',marginTop:'-100px'}}/>
                    </div>
